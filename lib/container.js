...
export default class Container {
  ...
  saveUser(user) {
    let container = this;
    return new Promise(function (resolve, reject) {
      container.makeRequest('user:update', user.toJSON())
      .then(function (body) {
  ...
  setDefaultACL(acl){
    this._defaultACL = acl || new ACL();
    this.Record.defaultACL = this._defaultACL;
  }
  ...
  setRecordCreateAccess(recordClass, roles) {
    ...
    let container = this;
    return new Promise(function (resolve, reject) {
      container.makeRequest('record:create_access', {
  ...
  get Record() {
    let RecordClass = Record;

    RecordClass.defaultACL = this.defaultACL;
