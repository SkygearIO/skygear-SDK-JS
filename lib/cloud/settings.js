...
export const settings = {
  ...
  pgPoolMax: parseInt(process.env.PG_POOL_MAX) || 10,
  pgPoolMin: parseInt(process.env.PG_POOL_MIN) || 4,
  pgPoolIdleTimeoutMillis:
    parseInt(process.env.PG_POOL_IDLE_TIMEOUT_MILLIS) || 30000,
  ...
  assetStoreURLExpireDuration:
    parseInt(process.env.ASSET_STORE_URL_EXPIRE_DURATION) || 3600,
