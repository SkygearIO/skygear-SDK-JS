 ...
 * credentials from a third-party. The Authentication Provider respond to
 ...
 * @param {object} ProviderCls - an provider class
...
/**
 * BaseAuthProvider provides example interface that a AuthProvider should
 * provide.
 *
 * To create a actual AuthProvider, you can extend the BaseAuthProvider and
 * provide `login`, `logout` and `info`.
 *
 * @example
