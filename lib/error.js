...
export const PluginInitializing = 121;

export const UnexpectedError = 10000;

function codeToString(code) {
  return _.findKey(exports, function (value) {
    return code === value;
  });
}
...
export class SkygearError extends Error {
  ...
  constructor(message, code, info) {
    ...
    this.code = code || UnexpectedError;
    this.info = info || null;
  }
